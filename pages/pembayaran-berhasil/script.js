...
function showToast(message) {
  ...
  // Update message if needed (keeping the icon)
...
function handleBeranda() {
  // Add a subtle fade-out before navigating
  ...
  setTimeout(() => {
    // In a real app, this would be a router.push('/') or window.location.href = '/'
    // For demo, we reset the page
...
// Run stagger after card animation completes
...
// Launch confetti burst after card appears
setTimeout(() => {
  for (let i = 0; i < 36; i++) {
